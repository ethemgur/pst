...
module.exports = function(vueApp) {
  ...
  /* ===== Step 3 Page events  ===== */
  myApp.onPageInit('step21', function(page) {
    $$('.reason-prompt123').on('click', function() {
      myApp.prompt('Yeni neden ekle', function(data) {
        // @data contains input value
        myApp.alert('Neden eklendi: ' + data);
      });
    });

    $$('.symptom-prompt').on('click', function() {
      myApp.prompt('Yeni şikayet ekle', function(data) {
        // @data contains input value
          myApp.alert('Şikayet eklendi: ' + data);
      });
    });
  ...
  myApp.onPageInit('progressbar', function(page) {
    $$('.ks-demo-progressbar-inline1 .button').on('click', function() {
      var progress = $$(this).attr('data-progress');
      var progressbar = $$('.ks-demo-progressbar-inline1 .progressbar');
      myApp.setProgressbar(progressbar, progress);
    });

    $$('.ks-demo-progressbar-inline2 .button').on('click', function() {
      var progress = $$(this).attr('data-progress');
      var progressbar = $$('.ks-demo-progressbar-inline2 .progressbar');
      myApp.setProgressbar(progressbar, progress);
    });

    $$('.ks-demo-progressbar-inline3 .button').on('click', function() {
      var progress = $$(this).attr('data-progress');
