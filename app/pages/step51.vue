<template>
  <div data-page="swiper-horizontal" class="page kitchen-sink-material">
    ...
    <a href="/step52/" class="floating-button color-purple" @click="pause2"><i class="material-icons">navigate_next</i></a>
...
export default {
  ...
  created() {
    this.src = 'https://www.youtube-nocookie.com/embed/VIAMg8iILC4'
